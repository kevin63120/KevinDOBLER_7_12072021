...
// 					return `<li class="secondarySearch-item-ingredient col-4" data-name = "${lower}">${lower}</li>`;
// 				});
...
// 				return `<li class="secondarySearch-item-ingredient col-4"  data-name = "${lower}">${elm}</li>`;
// 			});
...
// 				return `<li class="secondarySearch-item-appareil col-4 "  data-name = "${lower}">${lower}</li>`;
// 			});
...
// 					return `<li class="secondarySearch-item-ustensiles col-4" data-name = "${lower}">${lower}</li>`;
// 				})
// 			);
